...
export interface DatabaseConnectionMongoose extends DatabaseConnection, Document {
  createdAt: Date
  updatedAt: Date
}
...
export interface QueryResultHistoryMongoose extends IQueryResultHistory, Document {
  createdAt: Date
  updatedAt: Date
}
